...
import com.neklaway.hme_reporting.feature_time_sheet.data.SavedData.Companion.date
...
class UpdateVisaUseCase @Inject constructor(
    ...
    operator fun invoke(country:String,date: Calendar?,checked:Boolean,id:Long?): Flow<Resource<Boolean>> = flow {
