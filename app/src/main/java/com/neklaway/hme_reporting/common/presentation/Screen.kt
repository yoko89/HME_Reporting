...
sealed class Screen(
    ...
    object NewTimeSheetScreen :
        Screen("New", "new_time_sheet_screen", Icons.Default.NoteAdd)
    object EditTimeSheetScreen :
        Screen("Edit", "edit_time_sheet_screen", Icons.Default.EditNote)
    ...
    object SignatureScreen : Screen("Signature", "signature_screen", Icons.Default.Draw)
