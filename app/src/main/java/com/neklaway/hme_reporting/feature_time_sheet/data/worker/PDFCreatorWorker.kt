    ...
    override suspend fun doWork(
        ...
        for (currentItem in timeSheets) {
            ...
            if (currentPageCount > lastPageCreated) {
                ...
                canvas[currentPageCount].drawText(
                    timeSheets.first().date.toDate() + "   " + timeSheets.first().travelStart.toTime24(),
                ...
                canvas[currentPageCount].drawText(
                    timeSheets.last().date.toDate() + "   " + timeSheets.last().travelEnd.toTime24(),
                ...
                customerSign.await()?.let { customerSignature ->
                    ...
                    canvas[currentPageCount].drawText(
                        hmeCode.signatureDate.toTime24() + "  " + hmeCode.signatureDate.toDate(),
                        CUSTOMER_SIGNATURE_DATE_SHIFT,
