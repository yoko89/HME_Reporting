...
import com.neklaway.hme_reporting.feature_time_sheet.presentation.time_sheet.TimeSheetState
        ...
        viewModelScope.launch(Dispatchers.IO) {
            hmeCode.id?.let { id ->
                ...
                Log.d(
                    ...
                    "hmeSelected: Signature available = $result"
                )
                ...
                when (result) {
                    ...
                    is Resource.Success -> {
                        ...
                        result.data?.collect { timeSheetList ->
                            ...
                            Log.d(
                                com.neklaway.hme_reporting.feature_time_sheet.presentation.time_sheet.TAG,
                                "get timesheet by ibau: collect $timeSheetList "
                            )
